...
<body>
	<section id="content">
		...
		<h2>Datos de la secundaria de procedencia:</h2>
			<input autocomplete='off' class='label_better' id='sec_nombre' name='sec_nombre' placeholder='Nombre de la escuela' required title='Ingresa el nombre de la escuela secundaria de procedencia'>
